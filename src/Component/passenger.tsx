...
class Passenger extends React.Component<passengerProps, passengerState> {
  constructor(props: passengerProps){
    super(props);
    this.state = {show: false, addShow: false, id: 0, name:"", email:"", job:"", passengers:[]}
...
componentDidUpdate(prevProps: passengerProps, previousState: passengerState){
  APIService.getPassengers()
  ...
  <tbody>
     {this.state.passengers.map( (pass: Passengers) =>  (           
        ...
        <tr>
          ...
          <td>{pass.job}</td>
          <td>{pass.email}</td>
          <td><button onClick={()=>this.handleShow(pass)}>Edit</button></td>
          <td><button onClick={()=>this.handleOnDelete(pass.id)}>Delete</button></td>
        </tr>
          </React.Fragment>
          ))}
  </tbody>
...
<Modal
  ...
  <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
    ...
    <Form.Control type="text" placeholder="Enter the flight number"
    value={this.state.name} onChange={this.handleName}/>
  </Form.Group>
  <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
    <Form.Label>Email</Form.Label>
    <Form.Control type="text"  value={this.state.email} onChange={this.handleEmail} />
  </Form.Group>
  <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
    <Form.Label>Job</Form.Label>
    <Form.Control type="text"   value={this.state.job} onChange={this.handleJob}/>
  </Form.Group>
